...
public class DestinationWedding implements WeddingPackage {
    ...
    // change displayStatus to specify that it is a destination wedding
    @Override
    public void displayStatus() {
        System.out.println("Planning Destination Wedding: \nWedding Package Type: Destination Wedding \nVenue: " + getVenue() +
